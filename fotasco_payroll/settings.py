...
# STORAGES — Fixed duplicate BACKEND key
STORAGES = {
    "staticfiles": {
...
# MEDIA_URL = '/media/'         # later change to cloud storage if using Cloudinary/S3
# MEDIA_ROOT = os.path.join(BASE_DIR, 'media')



# Optional: Cloudinary storage for Render free tier
